...
export default function About() {
  ...
  return <main className="page-shell"><div className="container">
    ...
    <section className="split-page about-story"><div className="about-art"><img src="/images/banners/cinema-banner.webp" alt="A cinematic landscape" /><span>Stories worth<br />staying for.</span></div><div className="content-card"><span className="eyebrow">Why we exist</span><h2>Less scrolling.<br />More feeling.</h2><p>{siteSettings.aboutCopy}</p><a className="btn btn-primary" href="/contact">Talk to us →</a></div></section>
