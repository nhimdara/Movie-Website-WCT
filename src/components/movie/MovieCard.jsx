    ...
    <article className="movie-card">
      <div className="poster">
        ...
        <div className="card-actions">
          <button
            className="round-action play-action"
          ...
          <div>
            <button
              className={`round-action secondary${favourite ? " is-added" : ""}`}
              onClick={() => toggleFavourite(movie.id)}
              aria-label={`Toggle ${movie.title} favourite`}
            >
              <HeartIcon filled={favourite} />
            </button>
            <button
              className={`round-action secondary${saved ? " is-added" : ""}`}
              onClick={() => toggleWatchlist(movie.id)}
              aria-label={`Toggle ${movie.title} watchlist`}
            >
