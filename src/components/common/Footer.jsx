      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p>{t("footerCopy", siteSettings.footerTagline)}</p>
            <span className="footer-note">
              {t("movieNights", "Made for movie nights.")}
            </span>
          </div>
          <div>
            <h3>{t("explore", "Explore")}</h3>
            <a href="/movies">{t("allMovies", "All movies")}</a>
            <a href="/favourites">{t("favourites", "Favourites")}</a>
            <a href="/watchlist">{t("watchlist", "Watchlist")}</a>
          </div>
          <div>
          ...
          <div>
            ...
            <a href="/register">{t("createAccount", "Create account")}</a>
          </div>
        </div>
